...
public class AcionarSinistro extends JFrame {
	...
	public AcionarSinistro() {
		...
		tpSevico.setModel(
				new DefaultComboBoxModel(new String[] { "1 - Guincho", "2 - Policia", "3 - Samu", "4 - Bombeiros" }));
		...
		grauIntensidade.setModel(new DefaultComboBoxModel(new String[] { "1 - Somente ajuda para rebocar veiculo",
				"2 - Ajuda para pessoas", "3 - Desvirar Carro", "4 - Apagar incendio" }));
		...
		opcCusador.setModel(new DefaultComboBoxModel(
				new String[] { "1 - Batida", "2 - Furto", "3 - Capotamento", "4 - Incendio" }));
